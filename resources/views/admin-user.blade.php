...
<body >
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-liksthis"><a href="{{ route('/admin/users') }}"><i class="fa-solid fa-user-tie"></i> Gère les utilisateurs</a></li>
  ...
  <div class="data-table-container">
            ...
            <table class="data-table">
                ...
                <tbody>
                 @foreach($usersactuiel as $p)
                     <tr>
                        <td><strong>{{$p->nom}}</strong><br><small>{{$p->prenom}}</small></td>
                        <td>{{$p->email}}</td>
                        <td>{{$p->roles}}</td>
                        <td>{{$p->status}}</td>
                        <td>{{$p->created_at}}</td>
     ...
     <br>
        <div class="data-table-container" id="Demandes">
            <h2>les utilisateurs en atend </h2>
            <table class="data-table">
                <thead>
                    <tr>
                        <th>nom</th>
                ...
                <tbody>
                 @foreach($usersenatend as $p)
                     <tr>
                        ...
                        <td>{{$p->updated_at}}</td>
                        <td>
                        <form action="/apruve-user/{{$p->id}}" method="POST" style="display:inline;">
                          @csrf
                          @method('PUT')
