...
<body >
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="user-info">
      ...
      <!-- ✅ gradient username (still Laravel) -->
      <strong style="
  ...
  <div class="main-content" id="mainContent">
    ...
    <!-- ✅ small section label -->
    <div style="margin-bottom:12px; color:#9ca3af; font-size:0.95rem;">
      Aperçu rapide
    </div>
    ...
    <div class="data-table-container" style="margin-bottom: 30px;">
      <h2>Réservations créées (l'année dernière)</h2>

      <!-- ✅ tiny subtitle for vibe -->
      <p style="margin-top:6px; margin-bottom:14px; color:#9ca3af; font-size:0.9rem;">
        Suivi quotidien basé sur les réservations créées sur les 12 derniers mois.
      </p>
  ...
  <script>
    ...
    new Chart(document.getElementById('reservationsChart'), {
      ...
      data: {
        labels,
        datasets: [{
          label: 'Réservations / jour (12 mois)',
          data: values,
          tension: 0.35,
          pointRadius: 0,
          pointHitRadius: 10,
      ...
      options: {
        ...
        scales: {
          x: {
            ticks: { color: '#9ca3af', maxTicksLimit: 12, autoSkip: true },
